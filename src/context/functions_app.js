...
export const MiPerfilDocente = async () => {
  let zelda = "http://150.136.248.85:8080/docente/" + (JSON.parse(localStorage.getItem('session'))).email;
  ...
  zelda = 'http://150.136.248.85:8080/coordinador/foto/'
  let foto = '';
  let archivo = '';
  try {
...
export const GestionarDocente = async () => {
  ...
  let zelda = "http://150.136.248.85:8080/docente/" + (localStorage.getItem('DOCENTE_EMAIL'));
  const value = await axios.get(zelda, {
    headers: {
      "X-Softue-JWT": localStorage.getItem('token_access')
    }
...
export const ListarDocentes = async () => {
  let zelda = "http://150.136.248.85:8080/docente/listar";
  const value = await axios.get(zelda, {
    headers: {
      "X-Softue-JWT": localStorage.getItem('token_access')
    }
...
export const MiPerfilEstudiante = async () => {
  ...
  let zelda = "http://150.136.248.85:8080/estudiante/" + email;
  const value = await axios.get(zelda, {
    headers: {
      "X-Softue-JWT": localStorage.getItem('token_access')
    }
...
export const GestionarEstudiante = async () => {
  let zelda = "http://150.136.248.85:8080/estudiante/" + (localStorage.getItem('ESTUDIANTE_EMAIL'));
...
export const MiPerfilAdministrativo = async () => {
  let zelda = "http://150.136.248.85:8080/administrativo/" + (JSON.parse(localStorage.getItem('session'))).email;
  const value = await axios.get(zelda, {
    headers: {
      "X-Softue-JWT": localStorage.getItem('token_access')
    }
...
export const GestionarAdministrativo = async () => {
  let zelda = "http://150.136.248.85:8080/administrativo/" + (localStorage.getItem('ADMINISTRATIVO_EMAIL'));
  const value = await axios.get(zelda, {
    headers: {
      "X-Softue-JWT": localStorage.getItem('token_access')
    }
...
export const MiPerfilLider = async () => {
  const email = (JSON.parse(localStorage.getItem('session'))).email
  let zelda = "http://150.136.248.85:8080/coordinador/" + email;
  const value = await axios.get(zelda, {
    headers: {
      "X-Softue-JWT": localStorage.getItem('token_access')
    }
...
export const GestionarEntidad = async () => {
  ...
  const entidad = (await axios.get('http://150.136.248.85:8080/entidadFinanciadora/' + email, config)).data
  console.log(entidad)
  let foto;
  let archivo;
  try {
    foto = await axios.get('http://150.136.248.85:8080/entidadFinanciadora/foto/' + email, {
      ...config,
      responseType: 'arraybuffer' // asegúrate de especificar el tipo de respuesta como arraybuffer
    }).then(response => {
      const base64Image = btoa(
