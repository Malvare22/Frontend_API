                ...
                <div className='col-md-6 col-12 p-5 d-flex justify-content-center align-items-center' style={{ background: "#68462C" }}>
                    <div className='flex-grow-1'>
                        ...
                        <div className='container border rounded m-0' style={{ backgroundColor: "#D9D9D9" }}>
                            ...
                            <PanelPrincipal navigate={navigate} backToggler={backToggler}></PanelPrincipal>
                        </div>
                    </div>
                </div>
            </div>
...
const PanelPrincipal = (props) => {
    ...
    const [formValues, setFormValues] = useState({ codigo: '', contrasenia: '' });
            ...
            <form>
                <div>
                    ...
                    <div className='d-flex justify-content-center'>
                        <input type='number' min={0} onChange={handleChange} className={`required form-control border-0 border-bottom rounded-0 border-dark shadow-none w-75 ${errors.codigo ? 'is-invalid' : ''}`} name='codigo' value={formValues.codigo} style={{ backgroundColor: "#D9D9D9" }}/>
                    </div>
                </div>
                <div>
                    <p className='text-center mt-4 fw-bold'>Establezca una contraseña:</p>
                    <div className='d-flex justify-content-center'>
                        <input onChange={handleChange} type={type} className={`required form-control border-0 border-bottom rounded-0 border-dark shadow-none w-75 ${errors.contrasenia ? 'is-invalid' : ''}`} name='contrasenia' value={formValues.contrasenia} style={{ backgroundColor: "#D9D9D9" }} />
                        {type === 'password' ? (
