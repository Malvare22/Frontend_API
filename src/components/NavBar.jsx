...
const Sidebar = () => {
  return (
    ...
    <Nav vertical className=' d-flex' style={{height :"100%"}}>
      ...
      <UncontrolledCollapse toggler="#Habilidades">
      ...
      <UncontrolledCollapse toggler="#idea">
      ...
      <UncontrolledCollapse toggler="#plan">
      ...
      <NavItem>
        ...
        <Row className='d-flex align-content-center align-items-center justify-content-end'>
            <Col className="d-flex justify-content-end text-white align-content-center" xs="3" >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-building-fill-gear" viewBox="0 0 16 16">
