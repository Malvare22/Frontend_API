...
const InfoGeneral = (props) => {
    ...
    const getDatos1 = async () => {
        ...
        let URL = 'http://150.136.248.85:8080/ideaNegocio/' + props.nombre;
    ...
    const editarIdea = async (areaN, TNuevo) => {
        ...
        let ruta = "http://150.136.248.85:8080/ideaNegocio/Actualizar";
    ...
    const getAreas = async () => {
        try {
            const response = await axios.get('http://150.136.248.85:8080/areaConocimiento' + Area, {
...
const Observaciones = (props) => {
    ...
    const subirIdea = async () => {
        ...
        if (selectedFile) {
            ...
            let ruta = "http://150.136.248.85:8080/ideaNegocio/agregarDocumento";
