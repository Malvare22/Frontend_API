...
const InfoGeneral = (props) => {
    ...
    const editarIdea = async (areaN, TNuevo) => {
        ...
        let ruta = "http://144.22.63.128:8080/ideaNegocio/Actualizar";
    ...
    const getAreas = async () => {
        try {
            const response = await axios.get('http://144.22.63.128:8080/areaConocimiento' + Area, {
...
const Observaciones = (props) => {
    ...
    const subirIdea = async () => {
        ...
        if (selectedFile) {
            ...
            let ruta = "http://144.22.63.128:8080/ideaNegocio/agregarDocumento";
