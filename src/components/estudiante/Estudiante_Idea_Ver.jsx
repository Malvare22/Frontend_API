...
const InfoGeneral = (props) => {
    ...
    const editarIdea = async (areaN, TNuevo) => {
        ...
        let ruta = "http://146.235.246.199:8080/ideaNegocio/Actualizar";
    ...
    const getAreas = async () => {
        try {
            const response = await axios.get('http://146.235.246.199:8080/areaConocimiento' + Area, {
...
const Observaciones = (props) => {
    ...
    const subirIdea = async () => {
        ...
        if (selectedFile) {
            ...
            let ruta = "http://146.235.246.199:8080/ideaNegocio/agregarDocumento";
