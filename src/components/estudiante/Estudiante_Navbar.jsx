    ...
    <Nav vertical className=' d-flex' style={{height :"100%"}}>
      ...
      <NavItem onClick={()=>setArrow01(!arrow01)}>
        ...
        <Row className='d-flex align-content-center align-items-center  justify-content-end'>
            ...
            <Col xs="9" className="d-flex text-white justify-content-between align-items-center"><Link to={''}>Habilidades de Emprendimiento{arrow01? arrowDown: arrowUp}</Link></Col>
          </Row>        
        </NavLink>
      </NavItem>
