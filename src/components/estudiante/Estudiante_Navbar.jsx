  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        let zelda2 = "http://144.22.32.132:8080/ideaNegocio/comprobarIdeaAprobada";
        let zelda3 = "http://144.22.32.132:8080/planNegocio/comprobarPlanAprobada";
        ...
        <NavItem>
          <NavLink href="#" className={`${setDisableEntidades ? 'disabled' : ''}`}>
            <Row className='d-flex align-content-center align-items-center justify-content-end'>
              ...
              <Col xs="9" className="d-flex text-white text-start justify-content-start align-content-center">
                <Link to={'EntidadesFinanciadoras'} style={{ textDecoration: "none", color: "white" }}>Abanico de Entidades</Link>
              </Col>
            </Row>
          </NavLink>
        </NavItem>
