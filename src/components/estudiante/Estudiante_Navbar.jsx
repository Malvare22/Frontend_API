...
const Sidebar = () => {
  ...
  return (
    <div class="d-flex flex-column flex-shrink-0 text-white" style={{ height: "100%" }}>
      ...
      <NavItem>
        <NavLink href="#">
          <Row className='d-flex align-content-center align-items-center'>
            ...
            <Col xs="9" className="d-flex text-white text-start justify-content-start align-content-center">Perfil</Col>
          </Row>
      ...
      <NavItem>
        ...
        <Row className='d-flex align-content-center align-items-center justify-content-end'>
            <Col className="d-flex justify-content-end text-white align-content-center" xs="3" >
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-briefcase-fill" viewBox="0 0 16 16">
      ...
      <NavItem>
        ...
        <Row className='d-flex align-content-center align-items-center justify-content-end'>
            <Col className="d-flex justify-content-end text-white align-content-center" xs="3" >
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-trophy-fill" viewBox="0 0 16 16">
