...
export default function TablaMaterialIdea(props) {
    ...
    const getMaterial = async () => {
        try {
            let urls;
            if(props.tipo !== "")  urls='http://150.136.248.85:8080/formato/material'+props.tipo;
            else  urls='http://150.136.248.85:8080/formato/materialGeneral';
    ...
    const getArchi = async (id) => {
        ...
        let URL = 'http://150.136.248.85:8080/formato/recuperar/'+id;
