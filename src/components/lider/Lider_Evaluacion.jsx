                                    ...
                                    <div className="row">
                                        <div className="col-6">
                                            <div className="container rounded-1 mb-3 p-4" style={{ background: "#B4B4B4" }}>
                                                ...
                                                {/* {console.log("id",props.identificador)}
                                                {console.log("calificadores",calificadores)}
                                                {console.log("profesores",profesores)}
                                                {console.log()} */}

                                                 { calificadores.length != 0 && calificadores[props.identificador].calificacionesInfo.map((v, i) => {            
                                        ...
                                        <div className="col-6">
                                                 ...
                                                 { calificadores.length != 0 && calificadores[props.identificador].calificacionesInfo.map((v, i) => {
                                                    ...
                                                    if (v.id.codigoDocente != null) {
                                                        ...
                                                        return <div key={i} className="row">
                                                            ...
                                                            {props.estado == "NA" ? colorin === "#000000" ? <div className="col-2">
                                            ...
                                            <div className="row mt-2">
                                                ...
                                                <div className="col-auto">
                                                    <p style={{ color: "#000" }}>{calificadores != 0 ? 
