...
export default function Tabla(props){
  const{state, alert, valor}=useAlert();
  ...
  <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
                ...
                <button type="button" name={d.titulo} id="eliminar" value={d.id} onClick={(alert)} class="btn" style={{width: "auto"}}>
  ...
  <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"></path>
      ...
      <Modal isOpen={state} style={modalStyles}>
        <ModalBody>
          <FormGroup>
            <Label id="texto">{valor}</Label>            
          </FormGroup>        
        </ModalBody>

        <ModalFooter>
            <Button color="danger">Eliminar</Button>
            <Button color="primary" onClick={alert}>Cancelar</Button>
        </ModalFooter>
      </Modal>
        </Sdiv>
  );
