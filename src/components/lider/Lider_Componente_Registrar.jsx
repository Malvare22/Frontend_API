...
const Information = () => {
    ...
    const validar = (user) => {
        ...
        let fail = false;
        // Implementa la lógica de validación y actualiza los errores si es necesario
        setErrors(errors);
        return !fail;
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Validar el formulario antes de realizar cualquier acción adicional
                    ...
                    <SInfo>
                        <div className='row' style={{ paddingTop: "60px" }}>
                            ...
                            <div className='col-sm-8 col-6'>
                                <input type="text" value={formValues.nombre} onChange={handleChange} className='form-control' name='nombre' maxLength="50" />
                        ...
                        <div className='row' style={{ paddingBottom: "60px" }}>
                            ...
                            <div className='col-sm-8 col-6'>
                                <input type="number" value={formValues.porcentaje} onChange={handleChange} className='form-control' name='telefono' min="1" max="100" />
                                <div className="invalid-feedback">Este campo solo admite números entre 1 y 100.</div>
                            </div>
                        </div>
                    </SInfo>
                </div>
                <div className='btns'>
                    <button type='submit' className='btn rounded-3'><h6 className='text-white'>Añadir componente</h6></button>
                    <button type='button' className='btn rounded-3'><h6 className='text-white'>Cancelar</h6></button>
                </div>
            </form>
            <Modal isOpen={state} centered={true}>
                <ModalBody className='d-flex justify-content-center align-content-center p-4'>
                    <h6 className='m-0 p-0'>¿Está seguro de añadir este componente a la evaluacion de competencias?</h6>
                </ModalBody>
                <ModalFooter className='d-flex justify-content-center'>
                    <Button color="primary" style={{ marginRight: "40px" }}>Aceptar</Button>
