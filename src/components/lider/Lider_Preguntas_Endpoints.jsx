...
export const getPreguntas = async ({preguntaInfo, setPreguntaInfo}) => {
    try {
        ...
        const response = await axios.get('http://144.22.32.132:8080/pregunta', config);
...
export const getPregunta = async ({preguntaInfo, setPreguntaInfo}) => {
    try {
        ...
        const response = await axios.get(`http://144.22.32.132:8080/pregunta/${localStorage.getItem('idPregunta')}`, config);
        const preguntaData = {
            ...response.data,
...
export const crearPregunta = async (datos) => {
    try {
        ...
        const response = await axios.post('http://144.22.32.132:8080/pregunta', formData, config);
...
export const actualizarPregunta = async (datos) => {
    try {
        ...
        await axios.patch('http://144.22.32.132:8080/pregunta', formData, config);
    }
    catch (error) {
        let msg = '';
        if (error.response) {
...
export const eliminarPregunta = async ({idPregunta}) => {
    try {
        ...
        await axios.delete(`http://144.22.32.132:8080/pregunta/${idPregunta}`, config);
...
export const crearRespuesta = async (respuesta) => {
    try {
        ...
        await axios.post('http://144.22.32.132:8080/respuesta', formData, config);
    }
    catch (error) {
        let msg = '';
        if (error.response) {
...
export const actualizarRespuesta = async (respuesta) => {
    try {
        ...
        await axios.patch('http://144.22.32.132:8080/respuesta', formData, config);
    }
    catch (error) {
        let msg = '';
        if (error.response) {
...
export const eliminarRespuesta = async (respuesta) => {
    try {
        ...
        await axios.delete(`http://144.22.32.132:8080/respuesta/${respuesta.id}`, config);
    }
    catch (error) {
        let msg = '';
        if (error.response) {
