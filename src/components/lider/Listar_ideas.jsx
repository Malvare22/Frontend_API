...
export default function Listar_Ideas() {
  ...
  const getIdeas = async () => {
    const value = await axios.get("http://150.136.248.85:8080/ideaNegocio", { headers: { "X-Softue-JWT": localStorage.getItem("token_access") } }
    ).then(
      response => {
  ...
  const handleFilter = async (filters) => {
    ...
    try {
      ...
      let value = await axios.post("http://150.136.248.85:8080/ideaNegocio/filtrar", formData, config
      ).then(
        response => {
          const data = response.data;
          console.log(data);
...
function Getdocentes() {
  ...
  const getDocentes = async () => {
    const value = await axios.get('http://150.136.248.85:8080/docente/listar', { headers: { "X-Softue-JWT": localStorage.getItem("token_access") } }
    ).then(
      response => {
        const data = response.data;
        return data;
...
function Getestudiantes() {
  ...
  const getEstudiantes = async () => {
    const value = await axios.get('http://150.136.248.85:8080/estudiante/listar', { headers: { "X-Softue-JWT": localStorage.getItem("token_access") } }
    ).then(
      response => {
        const data = response.data;
        return data;
...
function Getareas() {
  ...
  const getAreas = async () => {
    const value = await axios.get('http://150.136.248.85:8080/areaConocimiento', { headers: { "X-Softue-JWT": localStorage.getItem("token_access") } }
    ).then(
      response => {
        const data = response.data;
        return data;
