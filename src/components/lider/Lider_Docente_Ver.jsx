...
const VistaGeneral = () => {
    ...
    const usuario = JSON.parse(localStorage.getItem('DOCENTE_ALL'))
    ...
    return (
        <Sdiv01>
            <div id='principal' className=''>
                <img className='rounded-circle' src={`${props.usuario.foto.direccion==''? image_default:props.usuario.foto.direccion}`}></img>
