...
const InfoGeneral = (props) => {
    ...
    const getDatos1 = async () => {
        ...
        let URLs = 'http://146.235.246.199:8080/ideaNegocio/' + props.nombre;
    ...
    const asignarTutor = async (docente) => {
        ...
        if (TutorNuevo) {
            ...
            let ruta = 'http://146.235.246.199:8080/coordinador/asignar/' + idea + '/' + docente;
            console.log(ruta);
    ...
    const EliminarTutor = async () => {
        if (datos1.tutorInfo!=null) {
            ...
            let ruta = 'http://146.235.246.199:8080/administrativo/eliminarTutor/'+idea;
            //console.log(ruta);
