...
export const getCursos = async () => {
    try {
        ...
        const response = await axios.get(`http://150.136.248.85:8080/estudiante/listarCursos`, config);
...
export const getResultadosFiltrados = async (filtro) => {
    try {
        ...
        const response = await axios.post('http://150.136.248.85:8080/test/filtrar', formData, config);
        return response.data;
    }
    catch (error) {
        let msg = '';
...
export const getResultados = async () => {
    try {
        ...
        const response = await axios.get(`http://150.136.248.85:8080/test`, config);
        return response.data;        
    } catch (error) {
        console.error("Error al obtener los cursos:", error);
    }
