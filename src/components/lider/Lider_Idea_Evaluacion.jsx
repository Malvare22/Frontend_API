...
const Evaluaciones = (props) => {
    ...
    const ElimnarCalificadores = async (a, b) => {
        ...
        let URLd = 'http://150.136.248.85:8080/ideaNegocio/calificacion';
    ...
    const agregarTutor = async () => {
        ...
        if (correoDocente) {
            try {
                const response = await axios.post('http://150.136.248.85:8080/ideaNegocio/calificacion/' + props.nombre + '/' + correoDocente, {}, {
                    headers: {
