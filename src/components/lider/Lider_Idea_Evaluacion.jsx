...
const Evaluaciones = (props) => {
    ...
    const getCalificadores = async () => {
        ...
        let URLs = 'http://144.22.63.128:8080/ideaNegocio/evaluacion/' + props.nombre;
    ...
    const getDatos1 = async () => {
        ...
        let URL = 'http://144.22.63.128:8080/ideaNegocio/' + props.nombre;
    ...
    const ElimnarCalificadores = async (a, b) => {
        ...
        let URLd = 'http://144.22.63.128:8080/ideaNegocio/calificacion';
    ...
    const agregarTutor = async () => {
        ...
        if (correoDocente) {
            try {
                const response = await axios.post('http://144.22.63.128:8080/ideaNegocio/calificacion/' + props.nombre + '/' + correoDocente, {}, {
                    headers: {
    ...
    const enviarA_Plan = async () => {
        ...
        try {
            const response = await axios.post('http://144.22.63.128:8080/planNegocio/' + props.nombre, {}, {
                headers: {
                    "X-Softue-JWT": localStorage.getItem("token_access")
                }
            });
