...
const Evaluaciones = (props) => {
    ...
    const getDatos1 = async () => {
        ...
        let URL = 'http://146.235.246.199:8080/ideaNegocio/' + props.nombre;
    ...
    const ElimnarCalificadores = async (a, b) => {
        ...
        let URLd = 'http://146.235.246.199:8080/ideaNegocio/calificacion';
    ...
    const agregarTutor = async () => {
        ...
        if (correoDocente) {
            try {
                const response = await axios.post('http://146.235.246.199:8080/ideaNegocio/calificacion/' + props.nombre + '/' + correoDocente, {}, {
                    headers: {
    ...
    const enviarA_Plan = async () => {
        ...
        try {
            const response = await axios.post('http://146.235.246.199:8080/planNegocio/' + props.nombre, {}, {
                headers: {
                    "X-Softue-JWT": localStorage.getItem("token_access")
                }
            });
