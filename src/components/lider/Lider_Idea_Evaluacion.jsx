...
const Evaluaciones = (props) => {
    ...
    const getDatos1 = async () => {
        ...
        let URL = 'http://144.22.32.132:8080/ideaNegocio/' + props.nombre;
    ...
    const ElimnarCalificadores = async (a, b) => {
        ...
        let URLd = 'http://144.22.32.132:8080/ideaNegocio/calificacion';
    ...
    const agregarTutor = async () => {
        ...
        if (correoDocente) {
            try {
                const response = await axios.post('http://144.22.32.132:8080/ideaNegocio/calificacion/' + props.nombre + '/' + correoDocente, {}, {
                    headers: {
