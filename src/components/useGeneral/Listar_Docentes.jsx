...
const Table = (props) => {
    ...
    const deleteUser = async ()=>{
        ...
        try{
            await axios.get('http://144.22.63.128:8080/docente/deshabilitarDocente/'+ valor.correo, config)
            props.updater();
            toggleAlert(null)
        }
        catch(error){
                            ...
                            <tr key={d.codigo}>
                                ...
                                <td className='text-center align-middle'>
                                    <div>
                                        ...
                                        {(props.type!='lider')&& <button type="button" className="btn" onClick={() => { toggleB(d.correo) }} value={d.cedula} style={{ width: "auto", border: "none" }}>
...
export default function ListarDocentes(props) {    
    ...
    const getDocentes = async () => {
        ...
        value = await axios.get('http://144.22.63.128:8080/docente/listar', config)     
        console.log(value);
