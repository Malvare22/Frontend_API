...
const Table = (props) => {
    ...
    const disableStudent = async () => {
        ...
        try{
            await axios.get('http://144.22.63.128:8080/coordinador/deshabilitarUsuario/' + valor.correo, {
            headers: {
                            ...
                            <tr key={d.correo}>
                                ...
                                <td className='text-center align-middle'>
                                    <div>
                                        ...
                                        {props.type!='docente' && <button type="button" className="btn" onClick={()=>toggleB(d)} value={d.id} style={{ width: "auto", border: "none" }}>
...
export default function ListarEstudiantes(props) {
    ...
    const getEstudiantes = async () => {
        ...
        value = await axios.get('http://144.22.63.128:8080/estudiante/listar', config)
