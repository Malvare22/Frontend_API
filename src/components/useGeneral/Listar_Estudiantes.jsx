                            ...
                            <tr key={d.correo}>
                                ...
                                <td className='text-center align-middle'>
                                    <div>
                                        ...
                                        <button type="button" className="btn" onClick={()=>toggleB(d)} value={d.id} style={{ width: "auto", border: "none" }}>
...
export default function ListarEstudiantes() {
    ...
    const getEstudiantes = async () => {
        ...
        value = await axios.get('http://129.151.121.230:8080/estudiante/listar', config)
