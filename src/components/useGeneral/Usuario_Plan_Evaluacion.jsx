...
const Evaluaciones = (props) => {
    ...
    const ElimnarCalificadores = async (a, b) => {
        ...
        let URLd = 'http://146.235.246.199:8080/planNegocio/calificacion';
    ...
    const agregarTutor = async () => {
        ...
        if (correoDocente) {
            try {
                const response = await axios.post('http://146.235.246.199:8080/planNegocio/calificacion/' + props.nombre + '/' + correoDocente, {}, {
                    headers: {
