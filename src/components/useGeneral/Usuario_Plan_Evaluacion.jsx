...
const Evaluaciones = (props) => {
    ...
    const ElimnarCalificadores = async (a, b) => {
        ...
        let URLd = 'http://144.22.32.132:8080/planNegocio/calificacion';
    ...
    const agregarTutor = async () => {
        ...
        if (correoDocente) {
            try {
                const response = await axios.post('http://144.22.32.132:8080/planNegocio/calificacion/' + props.nombre + '/' + correoDocente, {}, {
                    headers: {
    ...
    const enviarA_Plan = async () => {
        ...
        try {
            const response = await axios.post('http://144.22.32.132:8080/planNegocio/' + props.nombre, {}, {
                headers: {
                    "X-Softue-JWT": localStorage.getItem("token_access")
                }
            });
