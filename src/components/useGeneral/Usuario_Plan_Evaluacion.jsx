...
const Evaluaciones = (props) => {
    ...
    const getCalificadores = async () => {
        ...
        let URLs = 'http://144.22.63.128:8080/planNegocio/evaluacion/' + props.nombre;
    ...
    const ElimnarCalificadores = async (a, b) => {
        ...
        let URLd = 'http://144.22.63.128:8080/planNegocio/calificacion';
    ...
    const agregarTutor = async () => {
        ...
        if (correoDocente) {
            try {
                const response = await axios.post('http://144.22.63.128:8080/planNegocio/calificacion/' + props.nombre + '/' + correoDocente, {}, {
                    headers: {
