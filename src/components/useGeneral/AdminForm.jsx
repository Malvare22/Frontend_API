...
import { FormAdministrativo, FormDocente, HeadEdit, HeadRegister } from '../useGeneral/UsersForm';

//Componente general
export default function AdminForm({site, type}) {
        ...
        <SContent>
            <div className='d-flex justify-content-center' id='d_head'>
                <div className='' id='head'>
                    {type=='registrar'? <HeadRegister></HeadRegister>:<HeadEdit></HeadEdit>}
                </div>
                <div className='' id="info"> <FormAdministrativo user={user} type={type}></FormAdministrativo></div>
            </div>
        </SContent>
