...
const InfoGeneral = (props) => {
    ...
    const getDatos1 = async () => {
        const URLs = 'http://129.151.121.230:8080/planNegocio/' + props.nombre;
        try {
    ...
    const getArchi = async () => {
        ...
        let URL = 'http://129.151.121.230:8080/planNegocio/recuperarDocumento/' + props.nombre;
    ...
    const agregarTutor = async () => {
        ...
        if (correoDocente) {
            try {
                ...
                const response = await axios.post('http://129.151.121.230:8080/docenteApoyoPlan', formData1, {
                    headers: {
    ...
    const eliminarDocenteApoyo = async () => {
        ...
        try {
            ...
            let URLd = 'http://129.151.121.230:8080/docenteApoyoPlan';
    ...
    const editarPlan = async () => {
        ...
        let ruta = "http://129.151.121.230:8080/planNegocio";
    ...
    const asignarTutor = async (docente) => {
        ...
        if (TutorNuevo) {
            ...
            let ruta = 'http://129.151.121.230:8080/administrativo/asignarPlan/' + idea + '/' + docente;
            //129.151.121.230:8080/administrativo/asignarPlan/timbers/
            //console.log(ruta);
...
const Observaciones = (props) => {
    ...
    const subirIdea = async () => {
        ...
        if (selectedFile) {
            ...
            let ruta = "http://129.151.121.230:8080/planNegocio/agregarDocumento";
...
function Tabla(props) {
    ...
    async function enviarDatos() {
        try {
            setError(null);
            const url = 'http://129.151.121.230:8080/planNegocio/calificacion';
    ...
    const observacionDocenteApoyo = async () => {
        if (comentario) {
            try {
                ...
                const URLd = 'http://129.151.121.230:8080/observacionPlan';
    ...
    const enviarEvaluacion = async () => {
        try {
            const response = await axios.post('http://129.151.121.230:8080/planNegocio/evaluacion/' + props.nombre, {}, {
                headers: {
                    "X-Softue-JWT": localStorage.getItem("token_access")
                }
            });
