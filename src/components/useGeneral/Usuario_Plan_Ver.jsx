...
const InfoGeneral = (props) => {
    ...
    const getDatos1 = async () => {
        const URLs = 'http://144.22.32.132:8080/planNegocio/' + props.nombre;
        try {
    ...
    const getProfesores = async () => {
        if (Area !== null) {
            try {
                const response = await axios.get('http://144.22.32.132:8080/docente/listar/' + Area, {
                    headers: { "X-Softue-JWT": localStorage.getItem("token_access") }
                });
                const data = response.data;
                setProfesores(data);
    ...
    const getArchi = async () => {
        ...
        let URL = 'http://144.22.32.132:8080/planNegocio/recuperarDocumento/' + props.nombre;
    ...
    const agregarTutor = async () => {
        ...
        if (correoDocente) {
            try {
                ...
                const response = await axios.post('http://144.22.32.132:8080/docenteApoyoPlan', formData1, {
                    headers: {
    ...
    const eliminarDocenteApoyo = async () => {
        ...
        try {
            ...
            let URLd = 'http://144.22.32.132:8080/docenteApoyoPlan';
    ...
    const editarPlan = async () => {
        ...
        let ruta = "http://144.22.32.132:8080/planNegocio";
    ...
    const asignarTutor = async (docente) => {
        ...
        if (TutorNuevo) {
            ...
            let ruta = 'http://144.22.32.132:8080/administrativo/asignarPlan/' + idea + '/' + docente;
            //144.22.32.132:8080/administrativo/asignarPlan/timbers/
            //console.log(ruta);
...
const Observaciones = (props) => {
    ...
    const subirIdea = async () => {
        ...
        if (selectedFile) {
            ...
            let ruta = "http://144.22.32.132:8080/planNegocio/agregarDocumento";
...
function Tabla(props) {
    ...
    const getIdeas = async () => {
        ...
        let URLs = 'http://144.22.32.132:8080/observacionPlan/' + props.nombre;
    ...
    async function enviarDatos() {
        try {
            setError(null);
            const url = 'http://144.22.32.132:8080/planNegocio/calificacion';
    ...
    const observacionDocenteApoyo = async () => {
        if (comentario) {
            try {
                ...
                const URLd = 'http://144.22.32.132:8080/observacionPlan';
    ...
    const enviarEvaluacion = async () => {
        try {
            const response = await axios.post('http://144.22.32.132:8080/planNegocio/evaluacion/' + props.nombre, {}, {
                headers: {
                    "X-Softue-JWT": localStorage.getItem("token_access")
                }
            });
