    ...
    <div id="Sidebar" className="d-flex flex-column flex-shrink-0 text-white" style={{}}>
      ...
      <Nav vertical className=' d-flex' style={{ height: "100%" }}>
        ...
        <UncontrolledCollapse id="despliegue" toggler="#Ideas">
          <NavItem>
            <NavLink className='offset-md-3 text-white text-start' href="#">
              <Link to={'Tutor/Ideas'} style={{ textDecoration: "none", color: "white" }}>Tutor</Link>
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink className='offset-md-3 text-white text-start' href="#">
              <Link to={'Apoyo/Ideas'} style={{ textDecoration: "none", color: "white" }}>Apoyo</Link>
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink className='offset-md-3 text-white text-start' href="#">
              <Link to={'Evaluador/Ideas'} style={{ textDecoration: "none", color: "white" }}>Evaluador</Link>
            </NavLink>
          </NavItem>
        ...
        <UncontrolledCollapse id="despliegue" toggler="#plan">
          <NavItem>
            <NavLink className='offset-md-3 text-white text-start' href="#">
              <Link to={'Tutor/Planes'} style={{ textDecoration: "none", color: "white" }}>Tutor</Link>
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink className='offset-md-3 text-white text-start' href="#">
              <Link to={'Apoyo/Planes'} style={{ textDecoration: "none", color: "white" }}>Apoyo</Link>
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink className='offset-md-3 text-white text-start' href="#">
              <Link to={'Evaluador/Planes'} style={{ textDecoration: "none", color: "white" }}>Evaluador</Link>
            </NavLink>
          </NavItem>
        </UncontrolledCollapse>
