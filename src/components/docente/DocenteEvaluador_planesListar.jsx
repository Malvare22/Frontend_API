...
export default function Listar_Planes() {
    ...
    const getPlanes = async () => {
        ...
        let value = await axios.post("http://144.22.32.132:8080/planNegocio/PlanesDocentesEvaluadores", formData, { headers: { "X-Softue-JWT": localStorage.getItem("token_access") } }
        ).then(
            response => {
    ...
    const handleFilter = async (filters) => {
        ...
        try {
            ...
            const value = await axios.post("http://144.22.32.132:8080/planNegocio/PlanesDocentesEvaluadores",  formData, config
            ).then(
                response => {
                    const data = response.data;
                    console.log(data)
            ...
            <div className="row">
                <div className="col-12 m-1 p-1">
                    ...
                    <div className="container">
                        <Filters onFilter={handleFilter}  user={'evaluador'}></Filters>
                        <br></br>
                        <Table data={filteredData}  user={'evaluador'}></Table>
                        <br></br>
                        <div className='row'>
                            <div className="col">
