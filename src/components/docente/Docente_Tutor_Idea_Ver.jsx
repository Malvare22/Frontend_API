...
const InfoGeneral = (props) => {
    ...
    const getDatos1 = async () => {
        const URLs = 'http://150.136.248.85:8080/ideaNegocio/' + props.nombre;
        try {
    ...
    //http://150.136.248.85:8080/estudiante/listarCursos
    ...
    const eliminarIntegrante = async (estudiante) => {
        ...
        try {
            ...
            let URLd = 'http://150.136.248.85:8080/ideaPlanteada/' + props.nombre + '/' + estudiante;
    ...
    const agregarIntegrante = async (estudiante) => {
        ...
        try {
            ...
            let URLd = 'http://150.136.248.85:8080/ideaPlanteada/borrar/' + props.nombre + '/' + estudiante;
            await axios.get(URLd, {
                headers: { "X-Softue-JWT": localStorage.getItem("token_access") }
            });
            window.location.reload();
    ...
    const eliminarDocenteApoyo = async () => {
        ...
        try {
            ...
            let URLd = 'http://150.136.248.85:8080/docenteApoyoIdea';
    ...
    const getArchi = async () => {
        ...
        let URL = 'http://150.136.248.85:8080/ideaNegocio/recuperarDocumento/' + props.nombre;
    ...
    const agregarTutor = async () => {
        ...
        if (correoDocente) {
            try {
                ...
                const response = await axios.post('http://150.136.248.85:8080/docenteApoyoIdea', formData1, {
                    headers: {
...
const Observaciones = (props) => {
    ...
    const eliminarDocenteApoyo = async () => {
        if (comentario) {
            try {
                ...
                const URLd = 'http://150.136.248.85:8080/observacionIdea';
    ...
    const enviarEvaluacion = async () => {
        try {
            const response = await axios.post('http://150.136.248.85:8080/ideaNegocio/evaluacion/'+props.nombre,{}, { 
                headers: {
                    "X-Softue-JWT": localStorage.getItem("token_access")
                }
            });
...
function Tabla(props) {
    ...
    const getIdeas = async () => {
        ...
        let URLs = 'http://150.136.248.85:8080/observacionIdea/' + props.nombre;
